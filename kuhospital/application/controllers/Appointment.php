...
class Appointment extends CI_Controller {
    ...
    public function create()
    {
        ...
        if ($check_appointment_exists === false) {
            $this->session->set_flashdata('exception','You are already registered'); 
        }
        /* -------------MESSAGE------------------ */
      ...
      {  
        ...
        $this->load->view('layout/main_wrapper',$data);
        //$mail['maildata'] = $this->appointment_model->read_by_id($appointment_id);
    ...
    */
    ...
    //will check for patient exist or not
    ...
    //will provide doctor data in the wropdown button
    ...
    //Will check for the appoinment in the database
