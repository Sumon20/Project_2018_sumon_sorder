              ...
              <div class="login-panel panel panel-success">
                  ...
                  if($error_msg){
                   ...
                   ?>
                      ...
                      <form role="form" method="post" action="<?php echo base_url('testlog/register_user'); ?>">
                          <fieldset>
                              ...
                              <div class="form-group">
                                  <input class="form-control" placeholder="Enter 10 diMobile No" name="mobile" type="number" value="">
                              </div>
