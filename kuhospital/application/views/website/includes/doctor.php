                            ...
                            <div class="item">
                                <div class="single-item">
                                    <div class="doctor-img">
                                        <a class="primary-img"  href="<?php echo base_url("doctor/profileview/$doctor->user_id") ?>" ><img src="<?= (!empty($doctor->picture)?base_url($doctor->picture):base_url('assets_web/images/icons/no-img.png')) ?>" class="img-responsive" alt=""></a>
                                    </div>
