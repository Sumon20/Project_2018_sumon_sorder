    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="social">
                    <ul>
                        <li><a href="<?php echo base_url('login') ?>" target="_blank" class="black"><i class="fa fa-lg fa-sign-in"> </i> Log In</a> </li>
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                ...
                <li><a href="<?= base_url('#about') ?>" class="page-scroll">About</a></li>
                <li><a href="<?= base_url('#service') ?>" class="page-scroll">Service</a></li>
                
                <li><a href="<?= base_url('#appointment') ?>" class="page-scroll">Appointment</a></li>
                <li><a href="<?= base_url('#doctor') ?>" class="page-scroll">Doctors</a></li>
                <li><a href="<?= base_url('#department') ?>" class="page-scroll">Department</a></li>
                <li><a href="http://localhost/clinic_directory/" class="page-scroll">Search</a></li>
                <li><a href="<?= base_url('#contact') ?>" class="page-scroll">Contact</a></li>
            </ul>
        </div> <!-- /.navbar-collapse --> 
    </div> <!--/.container --> 
</nav>