                                    ...
                                    <div class="col-md-9 col-sm-9 col-xs-9 pull-left">
                                        <div class="listing-tabs">
                                            <ul class="nav nav-tabs">
                                                <li class="active"><a data-toggle="tab" href="#recent-services">Recent Services</a></li>
                                                <li><a data-toggle="tab" href="#popular-services">Popular Services</a></li>
                                                <li><a data-toggle="tab" href="#all-services">All Services</a></li>
                                            </ul>
                            ...
                            <div class="listing-main gridview tab-content padding-top-30">
                                <div id="recent-services" class="tab-pane active">
                                    <div class="listing-wrapper three-column row">
                                        ...
                                        <?php foreach ($recent_services as $v_recent_service) { ?>
                                            <div class="item col-md-4 col-sm-6 col-xs-12"><!-- .ITEM -->
                                                <div class="listing-item clearfix">
                                                    <div class="figure">
                                                        <img src="<?php echo base_url('assets/uploaded_files/company_services/resize/' . $v_recent_service['image_path']); ?>" width="270" alt="<?php echo $v_recent_service['service_name']; ?>"/>
                                                        <div class="listing-overlay">
                                                            <div class="listing-overlay-inner rgba-bgblue-3">
                                                                <div class="overlay-content">
                                                                    <ul class="listing-links">
                                                                        <li><a class="bgwhite nohover" href="<?php echo base_url('services/service_details/' . $v_recent_service['service_id'] . '.html'); ?>"><i class="fa fa-search green-1 "></i></a></li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="listing-content clearfix">
                                                        ...
                                                        <div class="listing-title">
                                                            <h6><a href="<?php echo base_url('services/service_details/' . $v_recent_service['service_id'] . '.html'); ?>"><?php echo character_limiter($v_recent_service['service_name'], 15); ?></a></h6>
                                                        </div>
                                                        <div class="listing-disc">
                                                            <p></p>
                                                        </div>
                                                        <div class="listing-location pull-left"><!-- location-->
                                                            <a href="#"><i class="fa fa-briefcase"></i> <?php echo character_limiter($v_recent_service['company_name'], 24); ?></a>
                                                            <a href="#"><i class="fa fa-map-marker"></i> <?php echo $v_recent_service['address'] . ", " . $v_recent_service['state'] . ", " . $v_recent_service['city_name'] . ", " . $v_recent_service['zip']; ?></a>
                                                        </div><!-- location end-->
                                ...
                                <div id="popular-services" class="tab-pane">
                                    <div class="listing-wrapper three-column row">

                                        <?php foreach ($popular_services as $v_popular_service) { ?>
                                            <div class="item col-md-4 col-sm-6 col-xs-12"><!-- .ITEM -->
                                                <div class="listing-item clearfix">
                                                    <div class="figure">
                                                        <img src="<?php echo base_url('assets/uploaded_files/company_services/resize/' . $v_popular_service['image_path']); ?>" width="270" alt="<?php echo $v_popular_service['service_name']; ?>"/>
                                                        <div class="listing-overlay">
                                                            <div class="listing-overlay-inner rgba-bgblue-3">
                                                                <div class="overlay-content">
                                                                    <ul class="listing-links">
                                                                        <li><a class="bgwhite nohover" href="<?php echo base_url('services/service_details/' . $v_popular_service['service_id'] . '.html'); ?>"><i class="fa fa-search green-1 "></i></a></li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="listing-content clearfix">
                                                        ...
                                                        <div class="listing-title">
                                                            <h6><a href="<?php echo base_url('services/service_details/' . $v_popular_service['service_id'] . '.html'); ?>"><?php echo character_limiter($v_popular_service['service_name'], 15); ?></a></h6>
                                                        </div>
                                                        <div class="listing-disc">
                                                            <p></p>
                                                        </div>
                                                        <div class="listing-location pull-left"><!-- location-->
                                                            <a href="#"><i class="fa fa-briefcase"></i> <?php echo character_limiter($v_popular_service['company_name'], 24); ?></a>
                                                            <a href="#"><i class="fa fa-map-marker"></i> <?php echo $v_popular_service['address'] . ", " . $v_popular_service['state'] . ", " . $v_popular_service['city_name'] . ", " . $v_popular_service['zip']; ?></a>
                                                        </div><!-- location end-->
                                                        <div class="star-rating pull-right"><!-- rating-->
                                                            <!--<div class="score-callback" data-score="5"></div>-->
                                                        </div><!-- rating end-->
                                ...
                                <div id="all-services" class="tab-pane">
                                    <div class="listing-wrapper three-column row">
                                                ...
                                                <div class="item col-md-4 col-sm-6 col-xs-12"><!-- .ITEM -->
                                                    <div class="listing-item clearfix">
                                                        ...
                                                        <div class="listing-content clearfix">
                                                            ...
                                                            <div class="listing-title">
                                                                <h6><a href="<?php echo base_url('services/service_details/' . $v_service['service_id'] . '.html'); ?>"><?php echo character_limiter($v_service['service_name'], 15); ?></a></h6>
                                                            </div>
                                                            <div class="listing-disc">
                                                                <p></p>
                                                            </div>
                                                            <div class="listing-location pull-left"><!-- location-->
                                                                <a href="#"><i class="fa fa-briefcase"></i> <?php echo character_limiter($v_service['company_name'], 24); ?></a>
                                        ...
                                        <div id="remove_row">
                                            <center>
                                                <button type="button" name="btn_more" data-id="<?php echo $service_id; ?>" data-cid="" data-link="services/load_more_services" id="btn_more" class="btn btn-sm bgblue-3">Load more...</button>
                                            </center>
                                        </div>
                                    </div>
                                </div>
