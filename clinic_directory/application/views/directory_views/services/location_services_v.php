                                    ...
                                    <div class="col-md-9 col-sm-9 col-xs-9 pull-left">
                                        <div class="listing-tabs">
                                            <ul class="nav nav-tabs">
                                                <li class="active"><a data-toggle="tab"><?php echo $city_info['city_name']; ?> services</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                ...
                                <div id="recent-services" class="tab-pane active">
                                    <div class="listing-wrapper three-column row">
                                        ...
                                        <?php if (!empty($all_services)) { ?>
                                            ...
                                            <div id="remove_row">
                                                <center>
                                                    <button type="button" name="btn_more" data-id="<?php echo $service_id; ?>" data-cid="<?php echo $city_info['city_id']; ?>" data-link="services/load_more_location_services" id="btn_more" class="btn btn-sm bgblue-3">Load more...</button>
                                                </center>
                                            </div>
                                        <?php } else { ?>
                                            <div class="item col-md-12 col-sm-12 col-xs-12"><!-- .ITEM -->
                                                <h5 style="text-align: center; ">Service not found for this location !</h5>
                                            </div>
                                        <?php } ?>
