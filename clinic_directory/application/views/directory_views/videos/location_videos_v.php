                                    ...
                                    <div class="col-md-9 col-sm-9 col-xs-9 pull-left">
                                        <div class="listing-tabs">
                                            <ul class="nav nav-tabs">
                                                <li class="active"><a data-toggle="tab"><?php echo $city_info['city_name']; ?> videos</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                ...
                                <div id="recent-videos" class="tab-pane active">
                                    <div class="listing-wrapper three-column row">
                                        ...
                                        <?php if (!empty($all_videos)) { ?>
                                            ...
                                            <div id="remove_row">
                                                <center>
                                                    <button type="button" name="btn_more" data-id="<?php echo $video_id; ?>" data-cid="<?php echo $city_info['city_id']; ?>" data-link="videos/load_more_location_videos" id="btn_more" class="btn btn-sm bgpurpal-1">Load more...</button>
                                                </center>
                                            </div>
                                        <?php } else { ?>
                                            <div class="item col-md-12 col-sm-12 col-xs-12"><!-- .ITEM -->
                                                <h5 style="text-align: center; ">Video not found for this location !</h5>
                                            </div>
                                        <?php } ?>
