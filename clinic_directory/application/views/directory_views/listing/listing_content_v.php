                                    ...
                                    <div class="col-md-9 col-sm-9 col-xs-9 pull-left">
                                        <div class="listing-tabs">
                                            <ul class="nav nav-tabs">
                                                <li class="active"><a data-toggle="tab" href="#recent-listing">Recent Listing</a></li>
                                                <li><a data-toggle="tab" href="#popular-listing">Popular Listing</a></li>
                                                <li><a data-toggle="tab" href="#all-listing">All Listing</a></li>
                                            </ul>
                            ...
                            <div class="listing-main gridview tab-content padding-top-30">
                                <div id="recent-listing" class="tab-pane active">
                                    <div class="listing-wrapper three-column row">
                                        ...
                                        <?php foreach ($recent_listing as $v_recent_listing) { ?>
                                            <div class="item col-md-4 col-sm-6 col-xs-12"><!-- .ITEM -->
                                                <div class="listing-item clearfix">
                                                    <div class="figure">
                                                        <?php
                                                        $company_logo = '';
                                                        if (!empty($v_recent_listing['company_logo'])) {
                                                            $company_logo = "assets/uploaded_files/company_logo/resize/" . $v_recent_listing['company_logo'];
                                                        } else {
                                                            $company_logo = "assets/uploaded_files/company_logo/logo_not_available.png";
                                                        }
                                                        ?>
                                                        <img src="<?php echo base_url($company_logo); ?>" width="270" class="img-responsive img-bordered img-rounded" alt="<?php echo $v_recent_listing['company_name']; ?>"/>
                                                        <div class="listing-overlay">
                                                            <div class="listing-overlay-inner rgba-bgbrown-1">
                                                                <div class="overlay-content">
                                                                    <ul class="listing-links">
                                                                        <li><a class="bgwhite nohover" href="<?php echo base_url('listing/listing_details/' . $v_recent_listing['listing_id'] . '.html'); ?>"><i class="fa fa-search green-1 "></i></a></li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="listing-content clearfix">
                                                        ...
                                                        <div class="listing-title">
                                                            <h6><a href="<?php echo base_url('listing/listing_details/' . $v_recent_listing['listing_id'] . '.html'); ?>"><?php echo character_limiter($v_recent_listing['company_name'], 15); ?></a></h6>
                                                        </div>
                                                        <div class="listing-disc">
                                                            <p><?php echo character_limiter($v_recent_listing['about_company'], 250); ?></p>
                                                        </div>
                                                        <div class="listing-location pull-left"><!-- location-->
                                                            <a href="#"><i class="fa fa-briefcase"></i> <?php echo character_limiter($v_recent_listing['company_name'], 24); ?></a>
                                                            <a href="#"><i class="fa fa-map-marker"></i> <?php echo $v_recent_listing['address'] . ", " . $v_recent_listing['state'] . ", " . $v_recent_listing['city_name'] . ", " . $v_recent_listing['zip']; ?></a>
                                                        </div><!-- location end-->
                                ...
                                <div id="popular-listing" class="tab-pane">
                                    <div class="listing-wrapper three-column row">
                                        ...
                                        <?php foreach ($popular_listing as $v_popular_listing) { ?>
                                            <div class="item col-md-4 col-sm-6 col-xs-12"><!-- .ITEM -->
                                                <div class="listing-item clearfix">
                                                    <div class="figure">
                                                        <?php
                                                        $company_logo = '';
                                                        if (!empty($v_popular_listing['company_logo'])) {
                                                            $company_logo = "assets/uploaded_files/company_logo/resize/" . $v_popular_listing['company_logo'];
                                                        } else {
                                                            $company_logo = "assets/uploaded_files/company_logo/logo_not_available.png";
                                                        }
                                                        ?>
                                                        <img src="<?php echo base_url($company_logo); ?>" width="270" alt="<?php echo $v_popular_listing['company_name']; ?>"/>
                                                        <div class="listing-overlay">
                                                            <div class="listing-overlay-inner rgba-bgbrown-1">
                                                                <div class="overlay-content">
                                                                    <ul class="listing-links">
                                                                        <li><a class="bgwhite nohover" href="<?php echo base_url('listing/listing_details/' . $v_popular_listing['listing_id'] . '.html'); ?>"><i class="fa fa-search green-1 "></i></a></li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="listing-content clearfix">
                                                        ...
                                                        <div class="listing-title">
                                                            <h6><a href="<?php echo base_url('listing/listing_details/' . $v_popular_listing['listing_id'] . '.html'); ?>"><?php echo character_limiter($v_popular_listing['company_name'], 15); ?></a></h6>
                                                        </div>
                                                        <div class="listing-disc">
                                                            <p><?php echo character_limiter($v_recent_listing['about_company'], 250); ?></p>
                                                        </div>
                                                        <div class="listing-location pull-left"><!-- location-->
                                                            <a href="#"><i class="fa fa-briefcase"></i> <?php echo character_limiter($v_popular_listing['company_name'], 24); ?></a>
                                                            <a href="#"><i class="fa fa-map-marker"></i> <?php echo $v_popular_listing['address'] . ", " . $v_popular_listing['state'] . ", " . $v_popular_listing['city_name'] . ", " . $v_popular_listing['zip']; ?></a>
                                                        </div><!-- location end-->
                                                        <div class="star-rating pull-right"><!-- rating-->
                                                            <!--<div class="score-callback" data-score="5"></div>-->
                                                        </div><!-- rating end-->
                                ...
                                <div id="all-listing" class="tab-pane">
                                    <div class="listing-wrapper three-column row">
                                        ...
                                        <div id="remove_row">
                                            <center>
                                                <button type="button" name="btn_more" data-id="<?php echo $listing_id; ?>" data-cid="" data-link="listing/load_more_listing" id="btn_more" class="btn btn-sm bgbrown-1">Load more...</button>
                                            </center>
                                        </div>
