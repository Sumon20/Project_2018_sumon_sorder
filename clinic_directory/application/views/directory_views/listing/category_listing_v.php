                                    ...
                                    <div class="col-md-9 col-sm-9 col-xs-9 pull-left">
                                        <div class="listing-tabs">
                                            <ul class="nav nav-tabs">
                                                <li class="active"><a data-toggle="tab"><?php echo $category_info['category_name']; ?> listing</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                ...
                                <div id="recent-listing" class="tab-pane active">
                                    <div class="listing-wrapper three-column row">
                                        ...
                                        <?php if (!empty($all_listing)) { ?>
                                            ...
                                            <div id="remove_row">
                                                <center>
                                                    <button type="button" name="btn_more" data-id="<?php echo $listing_id; ?>" data-cid="<?php echo $category_info['category_id']; ?>" data-link="listing/load_more_category_listing" id="btn_more" class="btn btn-sm bgbrown-1">Load more...</button>
                                                </center>
                                            </div>
                                        <?php } else { ?>
                                            <div class="item col-md-12 col-sm-12 col-xs-12"><!-- .ITEM -->
                                                <h5 style="text-align: center; ">Listing not found for this category !</h5>
                                            </div>
                                        <?php } ?>
