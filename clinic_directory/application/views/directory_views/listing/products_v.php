                                    ...
                                    <?php foreach ($products_info as $v_product_info) { ?>
                                        <div class="item col-md-4 col-sm-6 col-xs-12"><!-- .ITEM -->
                                            <div class="listing-item clearfix">
                                                <div class="figure">
                                                    <img src="<?php echo base_url('assets/uploaded_files/company_products/resize/' . $v_product_info['image_path']); ?>" width="270" alt="<?php echo $v_product_info['product_name']; ?>"/>
                                                ...
                                                <div class="listing-content clearfix">
                                                    ...
                                                    <div class="listing-title">
                                                        <h6><a href="<?php echo base_url('products/product_details/' . $v_product_info['product_id'] . '.html'); ?>"><?php echo character_limiter($v_product_info['product_name'], 15); ?></a></h6>
                                                    </div>
                                                    <div class="listing-disc">
                                                        <p></p>
                                                    </div>
                                                    <div class="listing-location pull-left"><!-- location-->
                                                        <a href="#"><i class="fa fa-briefcase"></i> <?php echo character_limiter($v_product_info['company_name'], 24); ?></a>
                                                        <a href="#"><i class="fa fa-map-marker"></i> <?php echo $v_product_info['address'] . ", " . $v_product_info['state'] . ", " . $v_product_info['city_name'] . ", " . $v_product_info['zip']; ?></a>
                                                    </div><!-- location end-->
