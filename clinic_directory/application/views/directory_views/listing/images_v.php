                                    ...
                                    <?php foreach ($images_info as $v_image_info) { ?>
                                        <div class="item col-md-4 col-sm-6 col-xs-12"><!-- .ITEM -->
                                            <div class="listing-item clearfix">
                                                <div class="figure">
                                                    <img src="<?php echo base_url('assets/uploaded_files/company_img/resize/' . $v_image_info['image_path']); ?>" width="270" alt="<?php echo $v_image_info['caption']; ?>"/>
                                                ...
                                                <div class="listing-content clearfix">
                                                    ...
                                                    <div class="listing-location pull-left"><!-- location-->
                                                        <a href="#"><i class="fa fa-briefcase"></i> <?php echo character_limiter($v_image_info['company_name'], 24); ?></a>
                                                        <a href="#"><i class="fa fa-map-marker"></i> <?php echo $v_image_info['address'] . ", " . $v_image_info['state'] . ", " . $v_image_info['city_name'] . ", " . $v_image_info['zip']; ?></a>
                                                    </div><!-- location end-->
