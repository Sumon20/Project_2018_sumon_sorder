                                            ...
                                            <div class="listing-item clearfix">
                                                ...
                                                <div class="listing-content clearfix">
                                                    ...
                                                    <div class="listing-location pull-left"><!-- location-->
                                                        <a href="#"><i class="fa fa-briefcase"></i> <?php echo character_limiter($v_video_info['company_name'], 24); ?></a>
                                                        <a href="#"><i class="fa fa-map-marker"></i> <?php echo $v_video_info['address'] . ", " . $v_video_info['state'] . ", " . $v_video_info['city_name'] . ", " . $v_video_info['zip']; ?></a>
                                                    </div><!-- location end-->
