...
<div class="page-title-wrap bgyallow-1 padding-top-30 padding-bottom-30"><!-- section title -->
    <h4 class="white"><?php echo $product_info['product_name']; ?></h4>
                ...
                <div class="blog-section padding-bottom-40">
                    <div class="entry-wrap shadow-1"><!-- blog entry -->
                        <div class="entry-figure">
                            <img src="<?php echo base_url('assets/uploaded_files/company_products/' . $product_info['image_path']); ?>" width="100%" alt="blog entry">
                        </div>
                        <div class="entry-content">
                            ...
                            <div class="entry-metas">
                                <ul>
                                    <li><i class="fa fa-user green-1"></i>Posted by: <a><?php echo $product_info['company_name']; ?></a></li>
                                    <li><i class="fa fa-clock-o blue-1"></i> <a><?php echo date("d F Y - h:ia", strtotime($product_info['date_added'])); ?></a></li>
                                    ...
                                    <li><i class="fa fa-eye blue-4"></i><a><?php echo $product_info['total_views']; ?> &nbsp; Total views</a></li>
                                </ul>
                            </div>
                                ...
                                <div class="bookmark-heart">
                                    <ul>
                                        ...
                                        if (!empty($this->session->userdata('user_id'))) {
                                            if ($check_heart == 0) {
                                                echo "<li><a href='" . base_url('products/give_heart/' . $product_info['product_id'] . ".html") . "'><i class = 'fa fa-heart fa-3x red-1'></i> </a></li>";
                                            }
                                            if ($check_bookmark == 0) {
                                                echo " <li><a href='" . base_url('user/bookmarks/make_bookmark/' . $product_info['listing_id'] . ".html") . "'><i class = 'fa fa-bookmark fa-3x green-2'></i></a></li>";
                                            }
                                        } else {
                    ...
                    <div class="listing-owner-section shadow-1">
                        ...
                        <div class="listing-owner-wrapper clearfix">
                            <div class="listing-owner-figure pull-left">
                                <?php
                                $company_logo = '';
                                if (!empty($product_info['company_logo'])) {
                                    $company_logo = "assets/uploaded_files/company_logo/resize/" . $product_info['company_logo'];
                                } else {
                                    $company_logo = "assets/uploaded_files/company_logo/logo_not_available.png";
                                }
                                ?>
                                <img src="<?php echo base_url($company_logo); ?>" width="100%" class="img-responsive" alt="<?php echo $product_info['company_name']; ?>">

                            </div>
                            <div class="listing-owner-content pull-right">
                                <a class="user" href="#"><i class="fa fa-briefcase bgblue-1 white"></i><?php echo $product_info['company_name']; ?></a>
                                <a class="contact-number"><i class="fa fa-phone bgblue-1 white"></i><?php echo $product_info['mobile']; ?></a>
                                <a class="owner-adress"><i class="fa fa-map-marker bgblue-1 white"></i><?php echo $product_info['address'] . ", " . $product_info['state'] . ", " . $product_info['city_name'] . ", " . $product_info['zip']; ?></a>
                                <a class="view-profile white bgblue-1" href="<?php echo base_url('listing/listing_details/' . $product_info['listing_id']); ?>">view profile</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="comments-wrap margin-top-20">
                        ...
                        <?php if (!empty($this->session->userdata('user_id'))) { ?>
                            ...
                            <div class="contact-form-wrap margin-top-30"><!--.contact-form-wrap -->
                                <form class="row contact-form" action="<?php echo base_url('products/submit_comment/' . $product_info['product_id'] . '.html'); ?>" method="post"><!-- .row .contact-form -->
                        ...
                        <?php } else { ?>
                            ...
                            <div class="contact-form-wrap margin-top-30"><!--.contact-form-wrap -->
                                <form class="row contact-form" action="<?php echo base_url('user/login/check_user_login/' . $product_info['product_id'] . '/products.html'); ?>" method="post"><!-- .row .contact-form -->
                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12"><!-- form-field -->
        ...
        <div class = "modal-content">
            ...
            <div class = "modal-body">
                <div class=" listing-login-form">
                    <form action="<?php echo base_url('user/login/check_user_login/' . $product_info['product_id'] . '/products.html'); ?>" method="post">
