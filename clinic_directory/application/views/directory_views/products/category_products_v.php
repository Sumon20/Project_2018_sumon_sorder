                                    ...
                                    <div class="col-md-9 col-sm-9 col-xs-9 pull-left">
                                        <div class="listing-tabs">
                                            <ul class="nav nav-tabs">
                                                <li class="active"><a data-toggle="tab"><?php echo $category_info['category_name']; ?> products</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                ...
                                <div id="recent-products" class="tab-pane active">
                                    <div class="listing-wrapper three-column row">
                                        ...
                                        <?php if (!empty($all_products)) { ?>
                                                        ...
                                                        <div class="listing-item clearfix">
                                                            ...
                                                            <div class="listing-content clearfix">
                                                                ...
                                                                <div class="listing-title">
                                                                    <h6><a href="<?php echo base_url('products/product_details/' . $v_product['product_id'] . '.html'); ?>"><?php echo character_limiter($v_product['product_name'], 18); ?></a></h6>
                                                                </div>
                                                                <div class="listing-disc">
                                                                    <p></p>
                                                                </div>
                                                                <div class="listing-location pull-left"><!-- location-->
                                                                    <a href="#"><i class="fa fa-briefcase"></i> <?php echo character_limiter($v_product['company_name'], 27); ?></a>
                                            ...
                                            <div id="remove_row">
                                                <center>
                                                    <button type="button" name="btn_more" data-id="<?php echo $product_id; ?>" data-cid="<?php echo $category_info['category_id']; ?>" data-link="products/load_more_category_products" id="btn_more" class="btn btn-sm bgyallow-1">Load more...</button>
                                                </center>
                                            </div>
                                        <?php } else { ?>
                                            <div class="item col-md-12 col-sm-12 col-xs-12"><!-- .ITEM -->
                                                <h5 style="text-align: center; ">Product not found for this category !</h5>
                                            </div>
                                        <?php } ?>
