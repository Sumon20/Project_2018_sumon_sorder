                                    ...
                                    <div class="col-md-9 col-sm-9 col-xs-9 pull-left">
                                        <div class="listing-tabs">
                                            <ul class="nav nav-tabs">
                                                <li class="active"><a data-toggle="tab"><?php echo $city_info['city_name']; ?> images</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                ...
                                <div id="recent-images" class="tab-pane active">
                                    <div class="listing-wrapper three-column row">
                                        ...
                                        <?php if (!empty($all_images)) { ?>
                                            ...
                                            <div id="remove_row">
                                                <center>
                                                    <button type="button" name="btn_more" data-id="<?php echo $image_id; ?>" data-cid="<?php echo $city_info['city_id']; ?>" data-link="images/load_more_location_images" id="btn_more" class="btn btn-sm bggreen-1">Load more...</button>
                                                </center>
                                            </div>
                                        <?php } else { ?>
