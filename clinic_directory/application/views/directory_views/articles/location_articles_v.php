                                    ...
                                    <div class="col-md-9 col-sm-9 col-xs-9 pull-left">
                                        <div class="listing-tabs">
                                            <ul class="nav nav-tabs">
                                                <li class="active"><a data-toggle="tab"><?php echo $city_info['city_name']; ?> articles</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                ...
                                <div id="recent-articles" class="tab-pane active">
                                    <div class="listing-wrapper three-column row">
                                        ...
                                        <?php if (!empty($all_articles)) { ?>
                                            ...
                                            <div id="remove_row">
                                                <center>
                                                    <button type="button" name="btn_more" data-id="<?php echo $article_id; ?>" data-cid="<?php echo $city_info['city_id']; ?>" data-link="articles/load_more_location_articles" id="btn_more" class="btn btn-sm bgorange-1">Load more...</button>
                                                </center>
                                            </div>
                                        <?php } else { ?>
                                            <div class="item col-md-12 col-sm-12 col-xs-12"><!-- .ITEM -->
                                                <h5 style="text-align: center; ">Article not found for this location !</h5>
                                            </div>
                                        <?php } ?>
