...
<div class="row content-title">
    <div class="col-md-6 col-sm-6 col-xs-6">
        <h6 class="pull-left"> Add Product</h6>
    </div>
    <div class="col-md-6 col-sm-6 col-xs-6">
...
<div class="row manage-container">
    <div class="col-md-12 col-sm-12 col-xs-12">
        ...
        if ($count_products < $package_info['products']) {
            ?>
            <form name="add_product_form" class="custom-form" action="<?php echo base_url('user/products/store_product_details.html'); ?>" method="post" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="form-group">
                            <label for="product_name">Product Name <span class="required-field">*</span></label>
                            <input type="text" name="product_name" value="<?php echo set_value('product_name'); ?>" class="form-control margin-top-5" id="product_name" placeholder="Enter company name">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="form-group">
                            ...
                            <textarea rows="4" name="product_details" class="form-control margin-top-5" id="product_details" placeholder="Enter product details"><?php echo set_value('product_details'); ?></textarea>
