            ...
            <div class="row pricing-wrap style-2 clearfix">
                            ...
                            <div class="pricing shadow-1 clearfix">
                                ...
                                <div class="pricing-content">
                                    ...
                                    <div class="btn-1 margin-top-30">
                                        <a class="white bggreen-2" href="<?php echo base_url('user/upgrade_package/upgrade/' . $v_package_info['package_id'] . '.html'); ?>">Upgrade</a>
                                    </div>
                                </div>
                            </div>
                        </div><!-- pricing end -->
                ...
                <?php } else { ?>
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <p>You are using super package. You are not able to upgrade at this time.</p>
                    </div>
                <?php } ?>
            </div><!-- .row pricing end -->
        </div><!-- container end -->
