...
<div class="row content-title">
    <div class="col-md-6 col-sm-6 col-xs-6">
        <h6 class="pull-left"> Add Image</h6>
    </div>
    <div class="col-md-6 col-sm-6 col-xs-6">
...
<div class="row manage-container">
    <div class="col-md-12 col-sm-12 col-xs-12">
        ...
        if ($count_images < $package_info['images']) {
            ?>
            <form name="add_image_form" class="custom-form" action="<?php echo base_url('user/images/store_image_details.html'); ?>" method="post" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="form-group">
                            <label for="caption">Caption <span class="required-field">*</span></label>
                            <input type="text" name="caption" value="<?php echo set_value('caption'); ?>" class="form-control margin-top-5" id="caption" placeholder="Enter company name">
        ...
        <?php } else { ?>
            <p>You need to upgrade your package for add more Images. Please upgrade your package.</p>
        <?php } ?>
    </div>
</div>
<!-- End Add Container -->
...
<script type="text/javascript">
    document.forms['add_image_form'].elements['listing_id'].value = '<?php echo set_value('listing_id'); ?>';
</script>