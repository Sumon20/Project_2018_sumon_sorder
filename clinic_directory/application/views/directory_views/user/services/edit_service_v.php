...
<div class="row content-title">
    <div class="col-md-6 col-sm-6 col-xs-6">
        <h6 class="pull-left"> Edit Service</h6>
    </div>
    <div class="col-md-6 col-sm-6 col-xs-6">
        <ul class="list-inline pull-right">
            <li><a href="<?php echo base_url('user/dashboard.html'); ?>"><i class="fa fa-home"></i> Dashboard</a></li> >
            <li><a href="<?php echo base_url('user/services.html'); ?>"> Manage Services</a></li> > 
            <li><a class="active"> Edit Service</a></li>
        </ul>
    </div>
</div>
...
<div class="row manage-container">
    <div class="col-md-12 col-sm-12 col-xs-12 padding-top-10">
        ...
        <form name="edit_service_form" class="custom-form" action="<?php echo base_url('user/services/update_service_details/' . $service_info['service_id'] . '.html'); ?>" method="post" enctype="multipart/form-data">
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="form-group custom-group">
                        <label for="service_name">Service Name <span class="required-field">*</span></label>
                        <input type="text" name="service_name" value="<?php echo $service_info['service_name']; ?>" class="form-control margin-top-5" id="service_name" placeholder="Enter company name">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="form-group">
                            <label for="service_details">Service Details <span class="required-field">*</span></label>
                            <textarea rows="4" name="service_details" class="form-control margin-top-5" id="service_details" placeholder="Enter service details"><?php echo $service_info['service_details']; ?></textarea>
                ...
                <div class="col-md-6 col-sm-12 col-xs-12">
                    <div class="form-group">
                        <input name="current_picture" type="hidden" value="<?php echo $service_info['image_path']; ?>">
                        <img src="<?php echo base_url('assets/uploaded_files/company_services/resize/' . $service_info['image_path']); ?>" width="80" alt="<?php echo $service_info['image_path']; ?>">
                    </div>
                </div>
                <!-- End Col -->
                <div class="col-md-12 col-sm-12 col-xs-12">
...
<script type="text/javascript">
    document.forms['edit_service_form'].elements['listing_id'].value = '<?php echo $service_info['listing_id']; ?>';
</script>