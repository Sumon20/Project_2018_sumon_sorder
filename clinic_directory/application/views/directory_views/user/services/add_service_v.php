...
<div class="row content-title">
    <div class="col-md-6 col-sm-6 col-xs-6">
        <h6 class="pull-left"> Add Service</h6>
    </div>
    <div class="col-md-6 col-sm-6 col-xs-6">
        <ul class="list-inline pull-right">
            ...
            <li><a class="active"> Add Service</a></li>
        </ul>
    </div>
</div>
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="service_name" value="<?php echo set_value('service_name'); ?>" class="form-control margin-top-5" id="service_name" placeholder="Enter company name">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="form-group">
                            ...
                            <textarea rows="4" name="service_details" class="form-control margin-top-5" id="service_details" placeholder="Enter service details"><?php echo set_value('service_details'); ?></textarea>
