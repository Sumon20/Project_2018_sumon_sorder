...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><i class="fa fa-circle-o"></i> Edit City </li>
    </ol>
</section>
...
<section class="content">
    <div class="box box-success">
        ...
        <!-- form start -->
        <form role="form" name="city_edit_form" action="<?php echo base_url('admin/directory/cities/update_city/' . $city_info['city_id'] . '.html'); ?>" method="post">
            <!-- /.box-header -->
            <div class="box-body">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="city_name" value="<?php echo $city_info['city_name']; ?>" class="form-control" id="city_name" placeholder="Enter city_name name">
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <textarea name="description" class="form-control" id="description" placeholder="Enter description" rows="4"><?php echo $city_info['description']; ?></textarea>
...
<script type="text/javascript">
    document.forms['city_edit_form'].elements['country_id'].value = '<?php echo $city_info['country_id']; ?>';
    document.forms['city_edit_form'].elements['publication_status'].value = '<?php echo $city_info['publication_status']; ?>';
</script>
