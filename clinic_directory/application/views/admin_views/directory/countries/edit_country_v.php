...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><i class="fa fa-circle-o"></i> Edit Country </li>
    </ol>
</section>
...
<section class="content">
    <div class="box box-success">
        ...
        <!-- form start -->
        <form role="form" name="country_edit_form" action="<?php echo base_url('admin/directory/countries/update_country/' . $country_info['country_id'] . '.html'); ?>" method="post">
            <!-- /.box-header -->
            <div class="box-body">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="country_name" value="<?php echo $country_info['country_name']; ?>" class="form-control" id="country_name" placeholder="Enter country_name name">
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <textarea name="description" class="form-control" id="description" placeholder="Enter description" rows="4"><?php echo $country_info['description']; ?></textarea>
...
<script type="text/javascript">
    document.forms['country_edit_form'].elements['publication_status'].value = '<?php echo $country_info['publication_status']; ?>';
</script>