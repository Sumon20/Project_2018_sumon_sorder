...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><i class="fa fa-circle-o"></i> Add Employee</li>
    </ol>
</section>
...
<section class="content">
    <div class="box box-success">
        ...
        <!-- form start -->
        <form role="form" name="employee_add_form" action="<?php echo base_url('admin/peoples/create_employee.html'); ?>" method="post" enctype="multipart/form-data">
            <!-- /.box-header -->
            <div class="box-body">
                <div class="row">
                    <?php
...
<script type="text/javascript">
    document.forms['employee_add_form'].elements['activation_status'].value = '<?php echo set_value('activation_status'); ?>';
    document.forms['employee_add_form'].elements['gender'].value = '<?php echo set_value('gender'); ?>';
    document.forms['employee_add_form'].elements['access_label'].value = '<?php echo set_value('access_label'); ?>';
</script>
