...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><i class="fa fa-circle-o"></i> Edit User</li>
    </ol>
</section>
...
<section class="content">
    <div class="box box-success">
        ...
        <!-- form start -->
        <form role="form" name="user_edit_form" action="<?php echo base_url('admin/peoples/update_user/' . $user_info['user_id'] . '.html'); ?>" method="post" enctype="multipart/form-data">
            <!-- /.box-header -->
            <div class="box-body">
                <div class="row">
                    <?php
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="username" value="<?php echo $user_info['username']; ?>" class="form-control" id="username" placeholder="Enter username">
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="email_address" value="<?php echo $user_info['email_address']; ?>" class="form-control" id="email_address" placeholder="Enter email address">
                            </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            ?>
                            <img src="<?php echo $profile_picture; ?>" alt="" class="img-responsive img-bordered img-rounded" width="120">
                        </div>
                    </div>
                    <!-- /.col -->
                </div>
...
<script type="text/javascript">
    document.forms['user_edit_form'].elements['activation_status'].value = '<?php echo $user_info['activation_status']; ?>';
    document.forms['user_edit_form'].elements['gender'].value = '<?php echo $user_info['gender']; ?>';
    document.forms['user_edit_form'].elements['package_id'].value = '<?php echo $user_info['package_id']; ?>';
</script>